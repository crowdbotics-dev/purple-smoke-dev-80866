"""
Django settings for purple_smoke_dev_80866 project.
...
ROOT_URLCONF = 'purple_smoke_dev_80866.urls'
...
WSGI_APPLICATION = 'purple_smoke_dev_80866.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "purple_smoke_dev_80866 API",
    "DESCRIPTION": "API documentation for purple_smoke_dev_80866 App",
    "VERSION": "v1",
}
